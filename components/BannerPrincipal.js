  ...
  useEffect(() => {
    const loadAllData = async () => {
      try {
        ...
        // Solo ocultar fallback cuando los datos estén listos
  ...
  return (
    <div>
      ...
      <div className="relative w-full h-[85vh] md:h-[90vh] lg:h-[93vh]">
        {showFallback || carouselItems.length === 0 ? (
          // Fallback banner con altura consistente
          ...
          // BannerPrincipal con la misma altura
